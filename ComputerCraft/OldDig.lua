function IntroductionScreen()
    print "Place items in the following slots\n"

    print "1: Enderchest"
    print "15: Torches | optional"
    print "16: Fuel"
    print "\n I am in the bottom right? if not put me there"
...
function getDimensions()
    ...
    print "What is the Width (even is better): "
     zSize = tonumber(io.read())

    while turtle.getItemCount(1) < 1 do
      print "Please put an ENDER CHEST in slot 1."
